                            ...
                            <InspectorFieldGrid className="sm:grid-cols-2">
                              ...
                              {isRectShapeMode ? (
                                <SliderField
                                  ...
                                  step={0.01}
                                  value={
                                    activeProjectView.layout.rectCornerRadius
                                  }
                                  formatter={(value) =>
                            ...
                            <InspectorGroup title="Grid">
                              <InspectorFieldGrid className="sm:grid-cols-2">
                                ...
                                <SliderField
                                  ...
                                  step={1}
                                  value={
                                    activeProjectView.layout.gutterHorizontal
                                  }
                                  formatter={(value) =>
                                    `${Math.round(value)} px`
                                  }
                                ...
                                <SliderField
                                  ...
                                  step={1}
                                  value={
                                    activeProjectView.layout.gutterVertical
                                  }
                                  formatter={(value) =>
                                    `${Math.round(value)} px`
                                  }
                            ...
                            <InspectorGroup title="Strips">
                              <InspectorFieldGrid>
                                ...
                                <SliderField
                                  ...
                                  step={0.01}
                                  value={
                                    activeProjectView.layout.density /
                                    DENSITY_UI_SCALE
                                  }
                                  onChange={(value) =>
                                    patchProject((project) => ({
                            ...
                            <InspectorGroup title="Blocks">
                              <InspectorFieldGrid className="sm:grid-cols-2">
                                ...
                                <SliderField
                                  ...
                                  step={0.01}
                                  value={
                                    activeProjectView.layout.blockSplitBias
                                  }
                                  formatter={(value) => {
                            ...
                            <InspectorGroup title="Radial">
                              <InspectorFieldGrid className="sm:grid-cols-2">
                                <SliderField
                                  ...
                                  step={1}
                                  value={
                                    activeProjectView.layout.radialSegments
                                  }
                                  formatter={(value) => `${Math.round(value)}`}
                                  onChange={(value) =>
                                    patchProject((project) => ({
                                ...
                                <SliderField
                                  ...
                                  step={1}
                                  value={
                                    activeProjectView.layout.radialAngleOffset
                                  }
                                  formatter={(value) => `${Math.round(value)}°`}
                                  onChange={(value) =>
                                    patchProject((project) => ({
                                ...
                                <SliderField
                                  ...
                                  step={1}
                                  value={
                                    activeProjectView.layout.radialRingPhaseStep
                                  }
                                  formatter={(value) => `${Math.round(value)}°`}
                                  onChange={(value) =>
                                    patchProject((project) => ({
                                ...
                                <SliderField
                                  ...
                                  step={0.01}
                                  value={
                                    activeProjectView.layout.radialInnerRadius
                                  }
                                  formatter={(value) =>
                                    `${Math.round(value * 100)}%`
                                  }
                            ...
                            <InspectorGroup title="Organic">
                              <InspectorFieldGrid>
                                ...
                                <SliderField
                                  ...
                                  step={1}
                                  value={
                                    activeProjectView.layout.organicVariation
                                  }
                                  formatter={(value) => `${Math.round(value)}`}
                                  onChange={(value) =>
                                    patchProject((project) => ({
                            ...
                            <InspectorGroup title="Flow">
                              <InspectorFieldGrid>
                                ...
                                <SliderField
                                  ...
                                  step={0.01}
                                  value={
                                    activeProjectView.layout.flowBranchRate
                                  }
                                  formatter={(value) =>
                                    `${Math.round(value * 100)}%`
                                  }
                            ...
                            >
                              <InspectorFieldGrid className="sm:grid-cols-2">
                                ...
                                <SliderField
                                  ...
                                  step={1}
                                  value={
                                    activeProjectView.layout.threeDDistribution
                                  }
                                  formatter={(value) => `${Math.round(value)}`}
                                  onChange={(value) =>
                                    patchProject((project) => ({
                                ...
                                <SliderField
                                  ...
                                  step={0.01}
                                  value={
                                    activeProjectView.layout.threeDPerspective
                                  }
                                  formatter={(value) =>
                                    `${Math.round(value * 100)}%`
                                  }
                                ...
                                <SliderField
                                  ...
                                  step={0.01}
                                  value={
                                    activeProjectView.layout.threeDBillboard
                                  }
                                  formatter={(value) =>
                                    `${Math.round(value * 100)}%`
                                  }
                              ...
                              {isSymmetryActive ? (
                                <>
                                  <SliderField
                                    ...
                                    step={0.01}
                                    value={
                                      activeProjectView.layout.symmetryCenterX
                                    }
                                  ...
                                  <SliderField
                                    ...
                                    step={0.01}
                                    value={
                                      activeProjectView.layout.symmetryCenterY
                                    }
                                    formatter={formatPercentValue}
                                    onChange={(value) =>
                                      patchProject((project) => ({
                                  ...
                                  <SliderField
                                    ...
                                    step={0.01}
                                    value={
                                      activeProjectView.layout.symmetryJitter
                                    }
                                    formatter={formatPercentValue}
                                    onChange={(value) =>
                                      patchProject((project) => ({
                            ...
                            <InspectorFieldGrid>
                              ...
                              {isWeightedAssignment ? (
                                <SliderField
                                  ...
                                  step={0.01}
                                  value={
                                    activeProjectView.sourceMapping.sourceBias
                                  }
                                  onChange={(value) =>
                                    patchProject((project) => ({
                                      ...project,
                          ...
                          <InspectorGroup title="Kaleidoscope">
                            <InspectorFieldGrid>
                              <SliderField
                                ...
                                step={1}
                                value={
                                  activeProjectView.effects.kaleidoscopeSegments
                                }
                                formatter={(value) =>
                                  `${Math.round(value)} seg`
                                }
                                onChange={(value) =>
                                  patchProject((project) => ({
                                    ...project,
