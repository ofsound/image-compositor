...
describe("createProjectDocument", () => {
  it("creates a fully-populated local-first project document", () => {
    ...
    expect(project.finish.outerGlowOffsetX).toBe(0);
    expect(project.finish.outerGlowOffsetY).toBe(0);
    expect(project.finish.outerGlowBlur).toBe(0);
    expect(project.finish.outerGlowOpacity).toBe(0);
    expect(project.finish.outerGlowColor).toBe("#ffffff");
    expect(project.finish.innerGlowOffsetX).toBe(0);
    expect(project.finish.innerGlowOffsetY).toBe(0);
    expect(project.finish.innerGlowBlur).toBe(0);
    expect(project.finish.innerGlowOpacity).toBe(0);
    expect(project.finish.innerGlowColor).toBe("#ffffff");
    expect(project.finish.innerShadowOffsetX).toBe(0);
    expect(project.finish.innerShadowOffsetY).toBe(0);
    expect(project.finish.innerShadowBlur).toBe(0);
    expect(project.finish.innerShadowOpacity).toBe(0);
    expect(project.finish.innerShadowColor).toBe("#180f08");
