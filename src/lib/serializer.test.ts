...
const bundle: ImportedProjectBundle = {
  ...
  projectDoc: normalizeProjectDocument({
    ...
    finish: {
      ...
      layer3DPivotX: 0.45,
      layer3DPivotY: 0.58,
      layer3DPerspective: 0.72,
      layer3DCameraDistance: 0.64,
      layer3DDepth: 0.22,
      layer3DSurfaceMode: "saddle",
      layer3DSurfaceAmount: 0.36,
      layer3DSurfaceFrequency: 3.5,
      layer3DSurfacePhase: 42,
      layer3DSurfaceAngle: -18,
      layer3DSurfaceFocus: 0.68,
      layer3DSurfaceDetail: 32,
      brightness: 1.12,
      contrast: 0.94,
      saturate: 1.18,
      hueRotate: 24,
